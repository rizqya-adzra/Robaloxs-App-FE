<template>
  <div class="flex justify-start items-center p-5 w-screen h-screen">
    ...
    <div class="flex flex-col bg-white backdrop-blur-md rounded-3xl py-10 lg:w-[1200px] px-10 md:px-32 lg:px-64 mx-auto gap-5 md:gap-7">
      ...
      <div class="flex flex-col gap-3">
        <InputsDefault placeholder="Masukan Nama" type="Nama" label="Nama" variant="default" color="black" />
        <InputsDefault placeholder="Masukan Email" type="Email" label="Email" variant="default" color="black" />
        <InputsDefault placeholder="Masukan Password" type="Password" action="Forgot Password?" label="Password" variant="default" color="black" />
        <InputsDefault placeholder="Masukan Konfirmasi Password" type="Password" label="Konfirmasi Password" variant="default" color="black" />
      </div>
      <div class="flex flex-col gap-8 text-center">
        <div class="flex flex-col gap-3">
          <ButtonsPrimary variant="solid" color="black" class="rounded-lg">Daftar</ButtonsPrimary>
          <p class="font-inter text-sm text-black/70">Udah punya akun? <a href="login" class="font-bold underline">Masuk</a></p>
        </div>
        <div class="space-y-4">
          ...
          <div class="flex justify-between md:justify-evenly items-center px-16">
            ...
            <p href="/" class="font-inter font-bold text-accent transition-all duration-300">-</p>
